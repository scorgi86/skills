...
- Save automatically under `.codex/inventory-artifacts/<target-slug>-<scope-digest>/stage-N`, unless the user supplies another path. Do not ask for path or format merely to begin.
