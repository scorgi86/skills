...
test("all command handlers import without executing, writing or exiting", () => {
  const expected = ["ast_batch", "batch_source_anchors", "canonical_stage_cli", "compare_mechanisms", "compare_stage_runs", "coverage_gate", "diagnose", "extract_stage_transition", "feature_search_matrix", "full_run", "goal_contract", "human_report_codec", "inventory_search", "measure_context", "preflight_package", "preflight_stage_request", "prototype_ast", "quality_equivalence", "query_stage_artifacts", "quick_validate", "render_stage1_report", "render_stage2_report", "source_evidence", "source_slice", "stage0_runner", "stage1_runner", "stage2_runner", "stage3_runner", "stage4_runner", "stage5_equivalence_gate", "stage5_runner", "stage6_runner", "stage7_coverage_gate", "stage7_equivalence_gate", "stage7_runner", "stage8_runner", "stage_pipeline", "stage_state", "validate_inventory_report", "validate_inventory_stage", "validate_skill"];
