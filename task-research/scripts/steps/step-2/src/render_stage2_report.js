...
const { resolveCompactAnchor } = require("../../../shared/output/src/summary/compaction.js");

const { assertHumanReadableMarkdown, decodeHumanFields, humanGroupName } = require("../../../shared/output/src/human_report_codec.js");
...
function renderStage2BundleReport({ facts, findings, transition, artifacts, maxFindings = 60 }) {
  ...
  const lines = [
    ...
    "    F --> G[\"Coverage gate\"]",
    "    G --> H[\"Отчёт и canonical artifact\"]",
