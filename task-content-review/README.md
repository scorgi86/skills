...
`task-content-review` оценивает, достаточно ли описания задачи и БФТ, чтобы начать разработку. Скилл выявляет недостатки требований, проверяет обязательные связанные материалы и готовит один из результатов:
...
```text
Используй $task-content-review. Режим standard.
